                            ...
                            <div class=message_widgets>
                                <a href="#">
                                    <div class=inbox-item>
                                        <div class=inbox-item-img><img src="{{url('theme/adminpix/assets/dist/img/avatar.png')}}" class=img-circle alt=""></div>
                                ...
                                <a href="#">
                                    <div class=inbox-item>
                                        <div class=inbox-item-img><img src="{{url('theme/adminpix/assets/dist/img/avatar2.png')}}" class=img-circle alt=""></div>
                                ...
                                <a href="#">
                                    <div class=inbox-item>
                                        <div class=inbox-item-img><img src="{{url('theme/adminpix/assets/dist/img/avatar3.png')}}" class=img-circle alt=""></div>
                                ...
                                <a href="#">
                                    <div class=inbox-item>
                                        <div class=inbox-item-img><img src="{{url('theme/adminpix/assets/dist/img/avatar4.png')}}" class=img-circle alt=""></div>
                                ...
                                <a href="#">
                                    <div class=inbox-item>
                                        <div class=inbox-item-img><img src="{{url('theme/adminpix/assets/dist/img/avatar5.png')}}" class=img-circle alt=""></div>
