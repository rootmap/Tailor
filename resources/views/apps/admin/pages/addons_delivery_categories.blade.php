...
@section('title','Addons Delivery Info')
@section('content')
<!-- Site wrapper -->
<div class="wrapper">
                  ...
                  <div class="panel panel-bd lobidrag">
                      <div class="panel-heading">
                          <div class="panel-title">
                              @if(isset($edit))
                              <h4>Update Addons Delivery info</h4>
                              @else
                              <h4>Create Addons Delivery info</h4>
                              @endif
                          </div>
                      </div>
                      <div class="panel-body">
                          ...
                          <div class="row">
                              <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                                  <form 
                                  @if(isset($edit))
                                  action="{{url('AddonsDelivery/update/'.$edit->id)}}" 
                                  @else
                                  action="{{url('AddonsDelivery/save')}}" 
                                  @endif
                                  ...
                                  @if(!empty($edit))<input type="hidden" name="eximage" value="{{$edit->image}}"> @endif
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-sm-12 col-form-label" for="exampleName">Image</label>
                                         <div class="col-lg-6 col-md-9 col-sm-12">
                                           @if(isset($edit))
                                           <img src="{{url('upload/AddonsDelivery/'.$edit->image)}}" width="50%"> <br> <br>
                                           @endif
                        ...
                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->price}}</td>
                                    <td>
                                        <a href="{{url('AddonsDelivery/edit/'.$row->id)}}" class="btn btn-base btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        <a href="{{url('AddonsDelivery/delete/'.$row->id)}}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    </td>
