                  ...
                  <div class="panel panel-bd lobidrag">
                      <div class="panel-heading">
                          <div class="panel-title">
                              @if(isset($edit))
                              <h4>Update Components info</h4>
                              @else
                              <h4>Create Components info</h4>
                              @endif
                          </div>
                      </div>
                      <div class="panel-body">
                          ...
                          <div class="row">
                              <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                                  <form 
                                  @if(isset($edit))
                                  action="{{url('components/update/'.$edit->id)}}" 
                                  @else
                                  action="{{url('components/save')}}" 
                                  @endif
                                  method="post">
                                    {!! csrf_field() !!}
                        ...
                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->name}}</td>
                                    <td>
                                        <a href="{{url('components/edit/'.$row->id)}}" class="btn btn-base btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        <a href="{{url('components/delete/'.$row->id)}}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    </td>
